            ...
            <div class="card border-danger">
                ...
                <div class="card-body">
                    ...
                    <blockquote class="blockquote bg-light p-3 rounded">
                        <strong>{{ $user_dev->u_name }}</strong> </blockquote>
                    <blockquote class="blockquote bg-light p-3 rounded">
                        <strong>{{ $user_dev->surname }}</strong> </blockquote>
                    <blockquote class="blockquote bg-light p-3 rounded">
                        <strong>{{ $user_dev->id_num }}</strong> </blockquote>
                    ...
                    <form action="{{ route('users_devs.destroy', $user_dev->id) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('users_devs.index') }}" class="btn btn-secondary">Cancelar</a>
