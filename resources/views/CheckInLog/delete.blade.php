            ...
            <div class="card border-danger">
                ...
                <div class="card-body">
                    ...
                    <blockquote class="blockquote bg-light p-3 rounded">
                        <strong>{{ $check_in_log->in_date }}</strong> </blockquote>
                    <blockquote class="blockquote bg-light p-3 rounded">
                        <strong>{{ $check_in_log->user_dev->id_num }}</strong> </blockquote>
                    <blockquote class="blockquote bg-light p-3 rounded">
                        <strong>{{ $check_in_log->user_dev->device_inventory->inv_num }}</strong> </blockquote>
                    ...
                    <form action="{{ route('check_in_logs.destroy', $check_in_log->id) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('check_in_logs.index') }}" class="btn btn-secondary">Cancelar</a>
